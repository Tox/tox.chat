...
if (window.navigator.userAgent.indexOf("Mac") != -1) {
	...
	clients = [{
		...
		icon: "download",
		desc: true,
		dlLink: "https://github.com/TokTok/qTox/releases/download/v1.18.1/qTox-arm64.dmg",
	}, {
		title: "qTox (Intel)",
		name: "qtox",
		icon: "download",
		desc: true,
		dlLink: "https://github.com/TokTok/qTox/releases/download/v1.18.1/qTox-x86_64.dmg",
	}];
}
...
if (window.navigator.userAgent.indexOf("Windows") != -1) {
	...
	if (arch == 64) {
		clients = [{
			...
			icon: "download",
			desc: true,
			dlLink: "https://github.com/TokTok/qTox/releases/download/v1.18.1/setup-qtox-x86_64-release.exe",
		}];
	} else {
		clients = [{
			title: "qTox 32-bit",
			...
			icon: "download",
			desc: true,
			dlLink: "https://github.com/TokTok/qTox/releases/download/v1.18.1/setup-qtox-i686-release.exe",
		}];
	}
}
